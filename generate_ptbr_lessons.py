...
# Very basic dictionary-based translation for key terms to make it PT-BR friendly
# Since we can't use an external translation API easily here without API keys.
...
def extract_content(text):
    ...
    if len(concepts) < 2:
        concepts = [
            {"title": "Definição", "desc": "Este componente é fundamental para a construção de interfaces gráficas ricas."},
            {"title": "Funcionalidade", "desc": "Permite interação do usuário e exibição de dados de forma visual."}
        ]
...
try:
    ...
    print("Sucesso! Aulas 04-15 geradas em PT-BR.")
